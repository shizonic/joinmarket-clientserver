...
def test_spend_freeze_script(setup_tx_creation):
    ...
    timeoffset_success_ticks_tests = [(2, False, 50), (2, True, 0), (-60*60*24*30, True, 0), (60*60*24*30, False, 0)]

    for timeoffset, required_success, ticks in timeoffset_success_ticks_tests:
        #generate keypair
        priv = "aa"*32 + "01"
